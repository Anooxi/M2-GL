...
public class SongListGenerator {
    public static void main(String[] args) {
        ...
        SongComponent industrial = new SongGroup("Industrial", "is a genre of music that draws on harsh, transgressive or provocative sounds and themes");
        SongComponent heavyMetal = new SongGroup("\nHeavy Metal", "is a genre of rock music that includes a group of related styles that are intense, virtuosic, and powerful");
