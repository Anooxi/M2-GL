...
public class Test {
    public static void main(String[] args) {
        ...
        SongComponent industrial = new SongGroup("Industrial", "A genre of music that draws on harsh, transgressive or provocative sounds and themes");
        ...
        // Dubstep Music genre
        SongComponent dubstep = new SongGroup("Dubstep", "A genre of electronic dance music that originated in South London in the late 1990s");
        ...
        SongComponent heavyMetal = new SongGroup("Heavy Metal", "A genre of rock music that includes a group of related styles that are intense, virtuosic, and powerful");
