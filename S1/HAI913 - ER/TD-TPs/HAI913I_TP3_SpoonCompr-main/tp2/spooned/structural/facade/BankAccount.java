...
public class BankAccount {
     ...
     *
     * @param number
     * 		The number of the Bank Account to create.
     * @param securityCode
     * 		The security code of the Bank Account
     * 		to create.
     * @param balance
     * 		The amount of money in the balance of the
     * 		Bank Account to create.
     */
    public BankAccount(int number, int securityCode, double balance) {
        this.number = number;
     ...
     *
     * @param number
     * 		The value to set this BankAccount's number.
     */
     ...
     *
     * @param securityCode
     * 		The value to set this BankAccount's
     * 		security code.
     */
     ...
     *
     * @param balance
     * 		The value to set this BankAccount's amount
