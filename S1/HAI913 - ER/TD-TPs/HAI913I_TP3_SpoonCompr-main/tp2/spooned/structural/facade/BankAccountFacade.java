...
public class BankAccountFacade {
     ...
     *
     * @param accountNumber
     * 		The account number provided to
     * 		the BankAccountFacade to create.
     * @param securityCode
     * 		The security code provided to
     * 		the BankAccountFacade to create.
     */
     ...
     *
     * @param cash
     * 		The cash to withdraw as requested by the client.
     */
    public void withdrawCash(double cash) {
        if ((numberChecker.match(accountNumber) && codeChecker.match(securityCode)) && balanceSystem.canWithdraw(cash)) {
     ...
     *
     * @param cash
     * 		The cash to deposit as requested by the client.
     */
    public void depositCash(double cash) {
        if (numberChecker.match(accountNumber) && codeChecker.match(securityCode)) {
