...
public class FileLogger extends Logger {
     ...
     *
     * @param level
     * 		The log request level associated with the
     ...
     *
     * @param filePath
     * 		The path of the file in which the FileLogger to create
     * 		will log
     * @param level
     * 		THe log request level associated with the FileLogger to create
     */
     ...
     *
     * @param filePath
     * 		The value to set this FileLogger's
