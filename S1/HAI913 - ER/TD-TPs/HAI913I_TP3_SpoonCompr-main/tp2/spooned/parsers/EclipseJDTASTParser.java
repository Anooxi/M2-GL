...
public class EclipseJDTASTParser extends Parser<ASTParser> {
    ...
    /* METHODS */
    public void setParser(int apiLevel, int kind, String complianceLevel, boolean resolveBindings, boolean bindingsRecovery, String encoding) {
        ...
        parser.setEnvironment(new String[]{ getProjectBinPath() }, new String[]{ getProjectSrcPath() }, new String[]{ encoding }, true);
    ...
    public void configure() {
        setParser(AST.JLS11, ASTParser.K_COMPILATION_UNIT, JavaCore.VERSION_1_8, true, false, "UTF-8");
    }
}