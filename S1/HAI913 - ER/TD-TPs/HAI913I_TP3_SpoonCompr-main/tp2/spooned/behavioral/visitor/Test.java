...
public class Test {
    public static void main(String[] args) {
        List<Product> products = Arrays.asList(new Necessity("Milk", 3.47), new Liquor("Vodka", 11.99), new Tobacco("Cigar", 19.99));
     ...
     *
     * @param products
     * 		The list of products whose taxes we wish to compute.
     * @param taxVisitor
     * 		The TaxVisitor instance used to compute the tax for
     * 		each product in products.
     */
    private static void computeTaxForProducts(List<Product> products, TaxVisitor taxVisitor) {
