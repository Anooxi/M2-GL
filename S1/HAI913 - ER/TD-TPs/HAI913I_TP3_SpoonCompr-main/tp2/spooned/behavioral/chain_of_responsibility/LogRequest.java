...
public class LogRequest {
     ...
     *
     * @param message
     * 		The message of the LogRequest to create.
     * @param level
     * 		The log request level of the LogRequest to create.
     */
     ...
     *
     * @param message
     * 		The value to set this LogRequest's message.
     */
     ...
     *
     * @param level
     * 		The value to set this LogRequest's level.
     */
