...
public class Test {
     ...
     *
     * @param anOperation
     * 		The ArithmeticOperation to compute.
     * @param operationSymbol
     * 		The ArithmeticOperation's associated symbol.
     * @param x
     * 		The x input integer.
     * @param y
     * 		The y input integer.
     */
    public static void computeAndDisplay(ArithmeticOperation anOperation, String operationSymbol, int x, int y) {
