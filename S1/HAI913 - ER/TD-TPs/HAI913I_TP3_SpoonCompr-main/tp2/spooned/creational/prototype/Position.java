...
public class Position implements Cloneable {
     ...
     *
     * @param x
     * 		Value to set the x component of this position.
     * @param y
     * 		Value to set the y component of this position.
     */
     ...
     *
     * @param x
     * 		The value to set this shape's x component.
     */
     ...
     *
     * @param y
     * 		The value to set this position's y component.
     */
    ...
    public String toString() {
        return ((((("[x = " + this.x) + ", y = ") + this.y) + ", hash = ") + this.hashCode()) + "]";
    }
}