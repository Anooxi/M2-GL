...
public abstract class AbstractMain {
    ...
    protected static void verifyTestProjectPath(BufferedReader inputReader, String userInput) throws IOException {
        while (!isJavaProject(userInput)) {
            System.err.println((("Error: " + userInput) + " either doesn't exist or isn't a java project folder. ") + "Please try again: ");
    ...
    protected void processUserInput(String userInput, Processor<?> processor) {
        System.err.println(("processUserInput(String userInput, ASTProcessor processor)" + " isn't implemented for ") + getClass().getCanonicalName());
    }

    protected void processUserInput(BufferedReader reader, String userInput, Processor<?> processor) {
        System.err.println(("processUserInput(BufferedReader reader, String userInput, ASTProcessor processor)" + " isn't implemented for ") + getClass().getCanonicalName());
    }
}