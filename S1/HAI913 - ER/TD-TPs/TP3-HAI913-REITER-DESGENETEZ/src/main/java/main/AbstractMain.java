...
public abstract class AbstractMain {
    ...
    protected static void setTestProjectPath(BufferedReader inputReader)
        ...
        System.out.println("Please provide the path to a java project's folder: ");
        System.out.println("Example : /home/e20160002389/M2-GL/S1/HAI913 - ER/TD-TPs/TP3-HAI913-REITER-DESGENETEZ/Projects/");
    ...
    protected static void verifyTestProjectPath(BufferedReader inputReader,
        ...
        while (!isAJavaProject(userInput)) {
    ...
    protected static boolean isAJavaProject(String projectPath) {
